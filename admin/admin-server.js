...
app.get('/api/monitor', async (req, res) => {
  ...
  try {
    ...
    const response = await axios.get(`http://${renderNodeIp}:4000/metrics`, { timeout: 5000 });
...
app.post('/api/start', async (req, res) => {
  ...
  try {
    const response = await axios.post(`http://${renderNodeIp}:4000/start`, {}, { timeout: 5000 });
...
app.post('/api/stop', async (req, res) => {
  ...
  try {
    const response = await axios.post(`http://${renderNodeIp}:4000/stop`, {}, { timeout: 5000 });
